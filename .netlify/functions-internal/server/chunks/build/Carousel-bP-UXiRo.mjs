...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-32dac427>`);
      if (_ctx.showControls && canGoPrevious.value) {
        _push(`<button class="carousel__control carousel__control--prev"${ssrRenderAttr("aria-label", _ctx.orientation === "horizontal" ? "Previous slide" : "Previous item")} data-v-32dac427>`);
        if (!_ctx.$slots.prevIcon) {
          _push(`<span data-v-32dac427>${ssrInterpolate(_ctx.orientation === "horizontal" ? "\u2039" : "\u2191")}</span>`);
        } else {
          _push(`<!---->`);
        }
      ...
      _push(`<div class="carousel__viewport" style="${ssrRenderStyle(viewportStyle.value)}" data-v-32dac427><div class="carousel__track" style="${ssrRenderStyle(trackStyle.value)}" data-v-32dac427><!--[-->`);
      ssrRenderList(_ctx.items, (item, index) => {
        _push(`<div class="${ssrRenderClass([{ "carousel__slide--active": index === currentIndex.value }, "carousel__slide"])}" style="${ssrRenderStyle(slideStyle.value)}"${ssrRenderAttr("aria-hidden", index !== currentIndex.value)} data-v-32dac427>`);
      ...
      if (_ctx.showControls && canGoNext.value) {
        _push(`<button class="carousel__control carousel__control--next"${ssrRenderAttr("aria-label", _ctx.orientation === "horizontal" ? "Next slide" : "Next item")} data-v-32dac427>`);
      ...
      if (_ctx.showIndicators) {
        _push(`<div class="carousel__indicators" data-v-32dac427><!--[-->`);
        ssrRenderList(_ctx.items, (_, index) => {
          _push(`<button class="${ssrRenderClass([{ "carousel__indicator--active": index === currentIndex.value }, "carousel__indicator"])}"${ssrRenderAttr("aria-label", `Go to slide ${index + 1}`)} data-v-32dac427></button>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
...
const Carousel = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-32dac427"]]);

export { Carousel as default };
//# sourceMappingURL=Carousel-bP-UXiRo.mjs.map
