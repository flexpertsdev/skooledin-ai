...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "overlays-demo" }, _attrs))} data-v-625114ab>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_LayoutStack, { spacing: "xl" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="demo-header" data-v-625114ab${_scopeId3}><h1 data-v-625114ab${_scopeId3}>Overlay Components Demo</h1><p data-v-625114ab${_scopeId3}>Modals, sheets, drawers, and notifications for mobile-first experiences</p></div><section data-v-625114ab${_scopeId3}><h2 data-v-625114ab${_scopeId3}>Modal Component</h2>`);
                        _push4(ssrRenderComponent(_component_LayoutRow, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<button class="demo-button" data-v-625114ab${_scopeId4}> Small Modal </button><button class="demo-button" data-v-625114ab${_scopeId4}> Large Modal </button><button class="demo-button" data-v-625114ab${_scopeId4}> Fullscreen Modal </button><button class="demo-button" data-v-625114ab${_scopeId4}> Persistent Modal </button>`);
                            } else {
                              return [
                                createVNode("button", {
                        ...
                        _push4(`</section><section data-v-625114ab${_scopeId3}><h2 data-v-625114ab${_scopeId3}>BottomSheet Component</h2>`);
                        _push4(ssrRenderComponent(_component_LayoutRow, {
                          gap: "md",
                          wrap: true
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<button class="demo-button" data-v-625114ab${_scopeId4}> Basic Bottom Sheet </button><button class="demo-button" data-v-625114ab${_scopeId4}> With Snap Points </button><button class="demo-button" data-v-625114ab${_scopeId4}> No Swipe to Close </button>`);
                            } else {
                              return [
                                createVNode("button", {
                        ...
                        _push4(`</section><section data-v-625114ab${_scopeId3}><h2 data-v-625114ab${_scopeId3}>ActionSheet Component</h2>`);
                        _push4(ssrRenderComponent(_component_LayoutRow, {
                          gap: "md",
                          wrap: true
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<button class="demo-button" data-v-625114ab${_scopeId4}> Basic Actions </button><button class="demo-button" data-v-625114ab${_scopeId4}> With Destructive Action </button><button class="demo-button" data-v-625114ab${_scopeId4}> With Icons </button>`);
                            } else {
                              return [
                                createVNode("button", {
                        ...
                        _push4(`</section><section data-v-625114ab${_scopeId3}><h2 data-v-625114ab${_scopeId3}>Drawer Component</h2>`);
                        _push4(ssrRenderComponent(_component_LayoutGrid, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<button class="demo-button" data-v-625114ab${_scopeId4}> Left Drawer </button><button class="demo-button" data-v-625114ab${_scopeId4}> Right Drawer </button><button class="demo-button" data-v-625114ab${_scopeId4}> Top Drawer </button><button class="demo-button" data-v-625114ab${_scopeId4}> Bottom Drawer </button>`);
                            } else {
                              return [
                                createVNode("button", {
                        ...
                        _push4(`</section><section data-v-625114ab${_scopeId3}><h2 data-v-625114ab${_scopeId3}>Toast Notifications</h2>`);
                        _push4(ssrRenderComponent(_component_LayoutGrid, {
                          cols: { mobile: 2, tablet: 4 },
                          gap: "md"
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<button class="demo-button" data-v-625114ab${_scopeId4}> Info Toast </button><button class="demo-button" data-v-625114ab${_scopeId4}> Success Toast </button><button class="demo-button" data-v-625114ab${_scopeId4}> Warning Toast </button><button class="demo-button" data-v-625114ab${_scopeId4}> Error Toast </button>`);
                            } else {
                              return [
                                createVNode("button", {
                        ...
                        _push4(ssrRenderComponent(_component_LayoutRow, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<button class="demo-button" data-v-625114ab${_scopeId4}> With Action </button><button class="demo-button" data-v-625114ab${_scopeId4}> Clickable Toast </button><button class="demo-button" data-v-625114ab${_scopeId4}> Persistent Toast </button>`);
                            } else {
                              return [
                                createVNode("button", {
                        ...
                        _push4(`</section><section data-v-625114ab${_scopeId3}><h2 data-v-625114ab${_scopeId3}>TabBar Component</h2>`);
                        _push4(ssrRenderComponent(_component_TabBar, {
                          ...
                          "panel-tab1": withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="tab-content" data-v-625114ab${_scopeId4}><h3 data-v-625114ab${_scopeId4}>Dashboard Content</h3><p data-v-625114ab${_scopeId4}>This is the dashboard tab content. You can swipe between tabs on mobile!</p></div>`);
                            } else {
                              return [
                          ...
                          "panel-tab2": withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="tab-content" data-v-625114ab${_scopeId4}><h3 data-v-625114ab${_scopeId4}>Analytics Content</h3><p data-v-625114ab${_scopeId4}>Analytics and charts would go here.</p></div>`);
                            } else {
                              return [
                                createVNode("div", { class: "tab-content" }, [
                          ...
                          "panel-tab3": withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="tab-content" data-v-625114ab${_scopeId4}><h3 data-v-625114ab${_scopeId4}>Reports Content</h3><p data-v-625114ab${_scopeId4}>Various reports and data exports.</p></div>`);
                            } else {
                              return [
                                createVNode("div", { class: "tab-content" }, [
                          ...
                          "panel-tab4": withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="tab-content" data-v-625114ab${_scopeId4}><h3 data-v-625114ab${_scopeId4}>Settings Content</h3><p data-v-625114ab${_scopeId4}>Application settings and configuration.</p></div>`);
                            } else {
                              return [
                                createVNode("div", { class: "tab-content" }, [
                        ...
                        _push4(`</section><section data-v-625114ab${_scopeId3}><h2 data-v-625114ab${_scopeId3}>Popover Component</h2>`);
                        _push4(ssrRenderComponent(_component_LayoutRow, {
                          gap: "md",
                          wrap: true
                        }, {
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_Popover, { placement: "top" }, {
                                trigger: withCtx(({ toggle }, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<button class="demo-button" data-v-625114ab${_scopeId5}> Click Popover </button>`);
                                  } else {
                                    return [
                                      createVNode("button", {
                                        onClick: toggle,
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div data-v-625114ab${_scopeId5}><h4 style="${ssrRenderStyle({ "margin-top": "0" })}" data-v-625114ab${_scopeId5}>Click Triggered</h4><p data-v-625114ab${_scopeId5}>This popover appears on click. Click outside or press ESC to close.</p></div>`);
                                  } else {
                                    return [
                              ...
                              _push5(ssrRenderComponent(_component_Popover, {
                                ...
                                trigger: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<button class="demo-button" data-v-625114ab${_scopeId5}> Hover Popover </button>`);
                                  } else {
                                    return [
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div data-v-625114ab${_scopeId5}><h4 style="${ssrRenderStyle({ "margin-top": "0" })}" data-v-625114ab${_scopeId5}>Hover Triggered</h4><p data-v-625114ab${_scopeId5}>This popover appears on hover with smooth transitions.</p></div>`);
                                  } else {
                                    return [
                                      createVNode("div", null, [
                              ...
                              _push5(ssrRenderComponent(_component_Popover, {
                                ...
                                trigger: withCtx(({ toggle }, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<button class="demo-button" data-v-625114ab${_scopeId5}> No Arrow </button>`);
                                  } else {
                                    return [
                                      createVNode("button", {
                                        onClick: toggle,
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div data-v-625114ab${_scopeId5}><p data-v-625114ab${_scopeId5}>This popover has no arrow pointer.</p></div>`);
                                  } else {
                                    return [
                                      createVNode("div", null, [
                              ...
                              _push5(ssrRenderComponent(_component_Popover, { placement: "left" }, createSlots({
                                trigger: withCtx(({ toggle, isOpen }, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<button class="${ssrRenderClass([{ active: isOpen }, "demo-button"])}" data-v-625114ab${_scopeId5}>${ssrInterpolate(isOpen ? "Close" : "Open")} Menu </button>`);
                                  } else {
                                    return [
                                      createVNode("button", {
                                        onClick: toggle,
                                ...
                                _ctx.$slots.default ? {
                                  ...
                                  fn: withCtx((slotProps, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="popover-menu" data-v-625114ab${_scopeId5}><button class="menu-item" data-v-625114ab${_scopeId5}>Profile</button><button class="menu-item" data-v-625114ab${_scopeId5}>Settings</button><button class="menu-item" data-v-625114ab${_scopeId5}>Help</button><hr data-v-625114ab${_scopeId5}><button class="menu-item" data-v-625114ab${_scopeId5}>Logout</button></div>`);
                                    } else {
                                      return [
                        ...
                        _push4(`</section><section data-v-625114ab${_scopeId3}><h2 data-v-625114ab${_scopeId3}>Tooltip Component</h2>`);
                        _push4(ssrRenderComponent(_component_LayoutRow, {
                          gap: "lg",
                          wrap: true
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_Tooltip, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<button class="demo-button" data-v-625114ab${_scopeId5}> Top Tooltip </button>`);
                                  } else {
                                    return [
                              ...
                              _push5(ssrRenderComponent(_component_Tooltip, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<button class="demo-button" data-v-625114ab${_scopeId5}> Right Tooltip </button>`);
                                  } else {
                                    return [
                              ...
                              _push5(ssrRenderComponent(_component_Tooltip, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<button class="demo-button" data-v-625114ab${_scopeId5}> Bottom Tooltip </button>`);
                                  } else {
                                    return [
                              ...
                              _push5(ssrRenderComponent(_component_Tooltip, { placement: "left" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<button class="demo-button" data-v-625114ab${_scopeId5}> Custom Content </button>`);
                                  } else {
                                    return [
                                ...
                                content: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div data-v-625114ab${_scopeId5}><strong data-v-625114ab${_scopeId5}>Rich Content Tooltip</strong><p style="${ssrRenderStyle({ "margin": "4px 0 0" })}" data-v-625114ab${_scopeId5}>You can add any content here!</p></div>`);
                                  } else {
                                    return [
                                      createVNode("div", null, [
                              ...
                              _push5(ssrRenderComponent(_component_Tooltip, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<span class="demo-link" data-v-625114ab${_scopeId5}>Hover over this link</span>`);
                                  } else {
                                    return [
      ...
      _push(ssrRenderComponent(_component_Modal, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-625114ab${_scopeId}>This is a small modal dialog. Perfect for confirmations and simple messages.</p>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_LayoutStack, { spacing: "md" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-625114ab${_scopeId2}>This is a large modal with more content space.</p><p data-v-625114ab${_scopeId2}>You can add forms, lists, or any other content here.</p><div class="demo-content-box" data-v-625114ab${_scopeId2}><p data-v-625114ab${_scopeId2}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p></div>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_LayoutStack, { spacing: "lg" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-625114ab${_scopeId2}>This modal takes up the full screen.</p><p data-v-625114ab${_scopeId2}>Great for immersive experiences or complex forms.</p>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_Modal, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-625114ab${_scopeId}>This modal can only be closed by clicking the close button.</p><p data-v-625114ab${_scopeId}>Clicking outside or pressing ESC won&#39;t close it.</p>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_LayoutStack, { spacing: "md" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-625114ab${_scopeId2}>This is a basic bottom sheet. Drag down to close on mobile!</p><p data-v-625114ab${_scopeId2}>It automatically adjusts its height based on content.</p>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_LayoutStack, { spacing: "md" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-625114ab${_scopeId2}>This sheet has multiple snap points: 25%, 50%, and 90% of screen height.</p><p data-v-625114ab${_scopeId2}>Drag up or down to snap between different heights!</p><!--[-->`);
                  ssrRenderList(10, (i) => {
                    _push3(`<div class="demo-content-box" data-v-625114ab${_scopeId2}><p data-v-625114ab${_scopeId2}>Content item ${ssrInterpolate(i)}</p></div>`);
                  });
                  _push3(`<!--]-->`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_BottomSheet, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-625114ab${_scopeId}>This sheet cannot be dismissed by swiping. Use the close button instead.</p>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_LayoutStack, { spacing: "md" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-625114ab${_scopeId2}>This drawer slides in from the left.</p><p data-v-625114ab${_scopeId2}>Swipe left to close on mobile devices.</p>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_LayoutStack, { spacing: "md" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-625114ab${_scopeId2}>This drawer slides in from the right with a larger size.</p><p data-v-625114ab${_scopeId2}>Perfect for filters, settings, or additional navigation.</p>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_Drawer, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-625114ab${_scopeId}>This drawer slides down from the top. Great for notifications or alerts.</p>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_Drawer, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-625114ab${_scopeId}>This drawer slides up from the bottom. Similar to a bottom sheet but with different styling.</p>`);
          } else {
            return [
...
const overlays = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-625114ab"]]);

export { overlays as default };
//# sourceMappingURL=overlays-gnaIATaq.mjs.map
