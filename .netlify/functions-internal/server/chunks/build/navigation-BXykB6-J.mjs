...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "navigation-demo" }, _attrs))} data-v-a810f152>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_LayoutStack, { spacing: "xl" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="demo-header" data-v-a810f152${_scopeId3}><h1 data-v-a810f152${_scopeId3}>Navigation Components Demo</h1><p data-v-a810f152${_scopeId3}>Mobile-first navigation patterns with responsive behavior</p></div><section data-v-a810f152${_scopeId3}><h2 data-v-a810f152${_scopeId3}>NavBar Component</h2><p data-v-a810f152${_scopeId3}>The NavBar is shown at the top of this page with scroll-aware behavior.</p><div class="demo-controls" data-v-a810f152${_scopeId3}><button class="demo-button" data-v-a810f152${_scopeId3}> Toggle Transparency: ${ssrInterpolate(unref(navTransparent) ? "ON" : "OFF")}</button></div></section><section data-v-a810f152${_scopeId3}><h2 data-v-a810f152${_scopeId3}>SideBar Component</h2>`);
                        _push4(ssrRenderComponent(_component_LayoutRow, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<button class="demo-button" data-v-a810f152${_scopeId4}> Open Left Sidebar </button><button class="demo-button" data-v-a810f152${_scopeId4}> Open Right Sidebar </button><button class="demo-button" data-v-a810f152${_scopeId4}> Open Persistent Sidebar </button>`);
                            } else {
                              return [
                                createVNode("button", {
                        ...
                        _push4(`</section><section data-v-a810f152${_scopeId3}><h2 data-v-a810f152${_scopeId3}>BottomNav Component</h2><p data-v-a810f152${_scopeId3}>${ssrInterpolate(unref(isMobile) ? "Check the bottom of your screen" : "Resize to mobile view to see the bottom navigation")}</p><div class="demo-controls" data-v-a810f152${_scopeId3}><button class="demo-button" data-v-a810f152${_scopeId3}> Toggle Labels: ${ssrInterpolate(unref(showBottomNavLabels) ? "ON" : "OFF")}</button></div></section><section data-v-a810f152${_scopeId3}><h2 data-v-a810f152${_scopeId3}>Scroll Behavior</h2><p data-v-a810f152${_scopeId3}>Scroll down to see how navigation components react:</p><!--[-->`);
                        ssrRenderList(20, (i) => {
                          _push4(`<div class="scroll-content" data-v-a810f152${_scopeId3}><p data-v-a810f152${_scopeId3}>Content block ${ssrInterpolate(i)} - Keep scrolling to see navigation behavior</p></div>`);
                        });
                        _push4(`<!--]--></section>`);
                      } else {
                        return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_LayoutStack, { spacing: "md" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-a810f152${_scopeId2}>This is a left-aligned sidebar with default settings.</p><nav data-v-a810f152${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_LayoutStack, { spacing: "sm" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<a href="#" class="sidebar-link" data-v-a810f152${_scopeId3}>Dashboard</a><a href="#" class="sidebar-link" data-v-a810f152${_scopeId3}>Profile</a><a href="#" class="sidebar-link" data-v-a810f152${_scopeId3}>Settings</a><a href="#" class="sidebar-link" data-v-a810f152${_scopeId3}>Help</a>`);
                      } else {
                        return [
                          createVNode("a", {
                            href: "#",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_LayoutStack, { spacing: "md" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-a810f152${_scopeId2}>This is a right-aligned sidebar with a larger size.</p><div class="sidebar-content-demo" data-v-a810f152${_scopeId2}><h3 data-v-a810f152${_scopeId2}>Features:</h3><ul data-v-a810f152${_scopeId2}><li data-v-a810f152${_scopeId2}>Swipe to close on mobile</li><li data-v-a810f152${_scopeId2}>Focus trap for accessibility</li><li data-v-a810f152${_scopeId2}>Backdrop click to close</li><li data-v-a810f152${_scopeId2}>ESC key support</li></ul></div>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_LayoutStack, { spacing: "md" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-a810f152${_scopeId2}>This sidebar is persistent - it can only be closed via the close button.</p><p data-v-a810f152${_scopeId2}>Clicking the backdrop won&#39;t close it.</p>`);
                } else {
                  return [
...
const navigation = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a810f152"]]);

export { navigation as default };
//# sourceMappingURL=navigation-BXykB6-J.mjs.map
