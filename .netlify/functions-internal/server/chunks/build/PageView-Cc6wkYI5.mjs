  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ref_key: "pageViewRef",
        ref: pageViewRef,
        class: ["page-view", [`page-view--${_ctx.orientation}`, isTransitioning.value && "page-view--transitioning"]]
      }, _attrs))} data-v-1ab7089d><div class="page-view__container" style="${ssrRenderStyle(containerStyle.value)}" data-v-1ab7089d><!--[-->`);
      ssrRenderList(_ctx.pages, (page, index) => {
        ...
        }, "page-view__page"])}" style="${ssrRenderStyle(getPageStyle(index))}"${ssrRenderAttr("aria-hidden", index !== currentIndex.value)} data-v-1ab7089d>`);
        ssrRenderSlot(_ctx.$slots, "page", {
          page,
          index,
          isActive: index === currentIndex.value
        }, () => {
          _push(`<div class="page-view__content" data-v-1ab7089d>${ssrInterpolate(page)}</div>`);
        }, _push, _parent);
        _push(`</div>`);
      });
      _push(`<!--]--></div>`);
      if (_ctx.showIndicators) {
        _push(`<div class="page-view__indicators" data-v-1ab7089d><!--[-->`);
        ssrRenderList(_ctx.pages, (_, index) => {
          _push(`<span class="${ssrRenderClass([{ "page-view__indicator--active": index === currentIndex.value }, "page-view__indicator"])}" data-v-1ab7089d></span>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
      ...
      if (_ctx.showArrows) {
        ...
        if (canGoPrevious.value) {
          _push(`<button class="page-view__arrow page-view__arrow--prev"${ssrRenderAttr("aria-label", _ctx.orientation === "horizontal" ? "Previous page" : "Previous section")} data-v-1ab7089d>`);
          ssrRenderSlot(_ctx.$slots, "prevArrow", {}, () => {
            _push(`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-1ab7089d><path d="M15 18l-6-6 6-6" data-v-1ab7089d></path></svg>`);
          }, _push, _parent);
          _push(`</button>`);
        } else {
          _push(`<!---->`);
        ...
        if (canGoNext.value) {
          _push(`<button class="page-view__arrow page-view__arrow--next"${ssrRenderAttr("aria-label", _ctx.orientation === "horizontal" ? "Next page" : "Next section")} data-v-1ab7089d>`);
          ssrRenderSlot(_ctx.$slots, "nextArrow", {}, () => {
            _push(`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-1ab7089d><path d="M9 18l6-6-6-6" data-v-1ab7089d></path></svg>`);
          }, _push, _parent);
          _push(`</button>`);
        } else {
          _push(`<!---->`);
...
const PageView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1ab7089d"]]);

export { PageView as default };
//# sourceMappingURL=PageView-Cc6wkYI5.mjs.map
