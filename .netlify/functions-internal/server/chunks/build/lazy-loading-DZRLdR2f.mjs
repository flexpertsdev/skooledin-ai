...
import { l as lazyComponent, E as ErrorBoundary, L as LoadingSpinner, p as preloadRouteComponentsAsync, c as createComponentLoader } from './ErrorBoundary-DvdbXxel.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const dynamicComponents = [
      {
        name: "BottomSheet",
        label: "Bottom Sheet",
        loader: () => import('./BottomSheet-BuIp15zi.mjs'),
        props: { modelValue: true, title: "Dynamic Bottom Sheet" }
      },
      {
        name: "ActionSheet",
        label: "Action Sheet",
        loader: () => import('./ActionSheet-DhkTpjnR.mjs'),
        props: {
          modelValue: true,
      ...
      },
      {
        name: "Toast",
        label: "Toast",
        loader: () => import('./Toast-C1GRq3eT.mjs'),
        props: {
          show: true,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "lazy-loading-demo" }, _attrs))} data-v-0bcdf387><header class="demo-header" data-v-0bcdf387>`);
      _push(ssrRenderComponent(_component_Container, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 class="demo-title" data-v-0bcdf387${_scopeId}>Lazy Loading</h1><p class="demo-description" data-v-0bcdf387${_scopeId}> Optimize performance with dynamic component loading, code splitting, and intersection observer-based lazy loading. </p>`);
          } else {
            return [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_Stack, { gap: 32 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<section class="demo-section" data-v-0bcdf387${_scopeId2}><h2 class="section-title" data-v-0bcdf387${_scopeId2}>Basic Lazy Loading</h2><p class="section-description" data-v-0bcdf387${_scopeId2}> Components are loaded only when needed, reducing initial bundle size. </p><div class="demo-card" data-v-0bcdf387${_scopeId2}><button class="toggle-button" data-v-0bcdf387${_scopeId2}>${ssrInterpolate(showBasic.value ? "Hide" : "Show")} Lazy Component </button>`);
                  if (showBasic.value) {
                    _push3(ssrRenderComponent(unref(LazyCarousel), {
                      ...
                      slide: withCtx(({ item }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="carousel-slide" data-v-0bcdf387${_scopeId3}><img${ssrRenderAttr("src", item.image)}${ssrRenderAttr("alt", item.title)} data-v-0bcdf387${_scopeId3}><h3 data-v-0bcdf387${_scopeId3}>${ssrInterpolate(item.title)}</h3></div>`);
                        } else {
                          return [
                  ...
                  _push3(`</div></section><section class="demo-section" data-v-0bcdf387${_scopeId2}><h2 class="section-title" data-v-0bcdf387${_scopeId2}>Visible-Based Loading</h2><p class="section-description" data-v-0bcdf387${_scopeId2}> Components load automatically when they enter the viewport. </p>`);
                  _push3(ssrRenderComponent(_component_Stack, { gap: 24 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<!--[-->`);
                        ssrRenderList(3, (i) => {
                          _push4(`<div class="demo-card" data-v-0bcdf387${_scopeId3}><h3 data-v-0bcdf387${_scopeId3}>Scroll to load component ${ssrInterpolate(i)}</h3>`);
                          _push4(ssrRenderComponent(unref(LazyVisibleModal), {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<p data-v-0bcdf387${_scopeId4}>This modal was loaded when it became visible in the viewport!</p><p data-v-0bcdf387${_scopeId4}>Check the network tab to see the lazy loading in action.</p>`);
                              } else {
                                return [
                  ...
                  _push3(`</section><section class="demo-section" data-v-0bcdf387${_scopeId2}><h2 class="section-title" data-v-0bcdf387${_scopeId2}>Route Preloading</h2><p class="section-description" data-v-0bcdf387${_scopeId2}> Preload components for specific routes to improve navigation speed. </p><div class="demo-card" data-v-0bcdf387${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_Stack, { gap: 16 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<!--[-->`);
                        ssrRenderList(routes, (route) => {
                          _push4(`<button class="route-button" data-v-0bcdf387${_scopeId3}> Preload ${ssrInterpolate(route.label)} Components </button>`);
                        });
                        _push4(`<!--]-->`);
                      } else {
                        return [
                  ...
                  if (preloadStatus.value) {
                    _push3(`<div class="preload-status" data-v-0bcdf387${_scopeId2}>${ssrInterpolate(preloadStatus.value)}</div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div></section><section class="demo-section" data-v-0bcdf387${_scopeId2}><h2 class="section-title" data-v-0bcdf387${_scopeId2}>Dynamic Components</h2><p class="section-description" data-v-0bcdf387${_scopeId2}> Load different components dynamically based on user interaction. </p><div class="demo-card" data-v-0bcdf387${_scopeId2}><div class="component-selector" data-v-0bcdf387${_scopeId2}><!--[-->`);
                  ssrRenderList(dynamicComponents, (comp) => {
                    _push3(`<button class="${ssrRenderClass(["selector-button", { active: selectedComponent.value === comp.name }])}" data-v-0bcdf387${_scopeId2}>${ssrInterpolate(comp.label)}</button>`);
                  });
                  _push3(`<!--]--></div><div class="dynamic-content" data-v-0bcdf387${_scopeId2}>`);
                  ...
                  _push3(`</div></div></section><section class="demo-section" data-v-0bcdf387${_scopeId2}><h2 class="section-title" data-v-0bcdf387${_scopeId2}>Performance Impact</h2><p class="section-description" data-v-0bcdf387${_scopeId2}> See the performance benefits of lazy loading in real-time. </p><div class="demo-card" data-v-0bcdf387${_scopeId2}><div class="metrics-grid" data-v-0bcdf387${_scopeId2}><div class="metric" data-v-0bcdf387${_scopeId2}><span class="metric-label" data-v-0bcdf387${_scopeId2}>Initial Bundle</span><span class="metric-value" data-v-0bcdf387${_scopeId2}>${ssrInterpolate(metrics.value.initialBundle)}</span><span class="metric-change" data-v-0bcdf387${_scopeId2}>-45%</span></div><div class="metric" data-v-0bcdf387${_scopeId2}><span class="metric-label" data-v-0bcdf387${_scopeId2}>First Paint</span><span class="metric-value" data-v-0bcdf387${_scopeId2}>${ssrInterpolate(metrics.value.firstPaint)}</span><span class="metric-change" data-v-0bcdf387${_scopeId2}>-60%</span></div><div class="metric" data-v-0bcdf387${_scopeId2}><span class="metric-label" data-v-0bcdf387${_scopeId2}>Interactive Time</span><span class="metric-value" data-v-0bcdf387${_scopeId2}>${ssrInterpolate(metrics.value.interactive)}</span><span class="metric-change" data-v-0bcdf387${_scopeId2}>-50%</span></div><div class="metric" data-v-0bcdf387${_scopeId2}><span class="metric-label" data-v-0bcdf387${_scopeId2}>Components Loaded</span><span class="metric-value" data-v-0bcdf387${_scopeId2}>${ssrInterpolate(metrics.value.componentsLoaded)}</span><span class="metric-detail" data-v-0bcdf387${_scopeId2}>of ${ssrInterpolate(metrics.value.totalComponents)}</span></div></div></div></section>`);
                } else {
                  return [
...
const lazyLoading = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0bcdf387"]]);

export { lazyLoading as default };
//# sourceMappingURL=lazy-loading-DZRLdR2f.mjs.map
