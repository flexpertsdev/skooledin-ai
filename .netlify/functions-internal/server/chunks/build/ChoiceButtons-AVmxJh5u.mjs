...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-ef036dbb>`);
      if (_ctx.label) {
        _push(`<div class="choice-label" data-v-ef036dbb>${ssrInterpolate(_ctx.label)} `);
        if (_ctx.required) {
          _push(`<span class="choice-required" data-v-ef036dbb>*</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      _push(`<div class="choice-buttons-container" data-v-ef036dbb><!--[-->`);
      ssrRenderList(normalizedOptions.value, (option, index) => {
        _push(`<button type="button" class="${ssrRenderClass([getButtonClasses(option), "choice-button"])}"${ssrIncludeBooleanAttr(isDisabled(option) || _ctx.disabled) ? " disabled" : ""}${ssrRenderAttr("aria-pressed", isSelected(option))} data-v-ef036dbb>`);
        if (getOptionIcon(option)) {
          _push(`<span class="button-icon" data-v-ef036dbb>`);
          ssrRenderVNode(_push, createVNode(resolveDynamicComponent(getOptionIcon(option)), null, null), _parent);
          _push(`</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<span class="button-content" data-v-ef036dbb><span class="button-label" data-v-ef036dbb>${ssrInterpolate(getOptionLabel(option))}</span>`);
        if (getOptionDescription(option)) {
          _push(`<span class="button-description" data-v-ef036dbb>${ssrInterpolate(getOptionDescription(option))}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</span>`);
        if (_ctx.showCheck && isSelected(option)) {
          _push(`<svg class="button-check" viewBox="0 0 24 24" fill="currentColor" data-v-ef036dbb><path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" data-v-ef036dbb></path></svg>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</button>`);
      ...
      if (_ctx.helperText || _ctx.error) {
        _push(`<div class="choice-helper" data-v-ef036dbb><span class="${ssrRenderClass({ "is-error": _ctx.error })}" data-v-ef036dbb>${ssrInterpolate(_ctx.error || _ctx.helperText)}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const ChoiceButtons = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ef036dbb"]]);

export { ChoiceButtons as default };
//# sourceMappingURL=ChoiceButtons-AVmxJh5u.mjs.map
