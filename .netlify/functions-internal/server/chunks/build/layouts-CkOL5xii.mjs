...
import { _ as __nuxt_component_6$1 } from './LayoutAligned-BniTJagZ.mjs';
import { _ as __nuxt_component_4 } from './LayoutWrap-DfSfpu8X.mjs';
import { _ as __nuxt_component_4$1 } from './LayoutExpanded-B2m_FVss.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_LayoutAligned = __nuxt_component_6$1;
      const _component_LayoutWrap = __nuxt_component_4;
      const _component_LayoutExpanded = __nuxt_component_4$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "layouts-demo" }, _attrs))} data-v-ac5292c5>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_LayoutStack, { spacing: "xl" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="demo-header" data-v-ac5292c5${_scopeId3}><h1 data-v-ac5292c5${_scopeId3}>Layout Primitives</h1><p data-v-ac5292c5${_scopeId3}>Flutter-inspired layout components for predictable UI composition</p></div><section data-v-ac5292c5${_scopeId3}><h2 data-v-ac5292c5${_scopeId3}>LayoutContainer</h2><p class="section-description" data-v-ac5292c5${_scopeId3}>Constrains content width and centers it horizontally</p><div class="demo-section demo-container" data-v-ac5292c5${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_LayoutContainer, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="demo-box" data-v-ac5292c5${_scopeId4}><p data-v-ac5292c5${_scopeId4}>This content is constrained to a maximum width and centered</p></div>`);
                            } else {
                              return [
                        ...
                        _push4(`</div></section><section data-v-ac5292c5${_scopeId3}><h2 data-v-ac5292c5${_scopeId3}>LayoutRow</h2><p class="section-description" data-v-ac5292c5${_scopeId3}>Horizontal layout with flexible spacing and alignment</p><div class="demo-subsection" data-v-ac5292c5${_scopeId3}><h3 data-v-ac5292c5${_scopeId3}>Basic Row</h3><div class="demo-section" data-v-ac5292c5${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_LayoutRow, { gap: "md" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="demo-box" data-v-ac5292c5${_scopeId4}>Item 1</div><div class="demo-box" data-v-ac5292c5${_scopeId4}>Item 2</div><div class="demo-box" data-v-ac5292c5${_scopeId4}>Item 3</div>`);
                            } else {
                              return [
                        ...
                        _push4(`</div></div><div class="demo-subsection" data-v-ac5292c5${_scopeId3}><h3 data-v-ac5292c5${_scopeId3}>Flexible Items</h3><div class="demo-section" data-v-ac5292c5${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_LayoutRow, { gap: "md" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="demo-box" style="${ssrRenderStyle({ "flex": "1" })}" data-v-ac5292c5${_scopeId4}>Flex: 1</div><div class="demo-box" style="${ssrRenderStyle({ "flex": "2" })}" data-v-ac5292c5${_scopeId4}>Flex: 2</div><div class="demo-box" style="${ssrRenderStyle({ "flex": "1" })}" data-v-ac5292c5${_scopeId4}>Flex: 1</div>`);
                            } else {
                              return [
                                createVNode("div", {
                                  class: "demo-box",
                        ...
                        _push4(`</div></div><div class="demo-subsection" data-v-ac5292c5${_scopeId3}><h3 data-v-ac5292c5${_scopeId3}>Alignment Options</h3><div class="demo-section" data-v-ac5292c5${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_LayoutRow, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="demo-box" style="${ssrRenderStyle({ "height": "40px" })}" data-v-ac5292c5${_scopeId4}>Short</div><div class="demo-box" style="${ssrRenderStyle({ "height": "80px" })}" data-v-ac5292c5${_scopeId4}>Tall</div><div class="demo-box" style="${ssrRenderStyle({ "height": "60px" })}" data-v-ac5292c5${_scopeId4}>Medium</div>`);
                            } else {
                              return [
                                createVNode("div", {
                                  class: "demo-box",
                        ...
                        _push4(`</div></div></section><section data-v-ac5292c5${_scopeId3}><h2 data-v-ac5292c5${_scopeId3}>LayoutColumn</h2><p class="section-description" data-v-ac5292c5${_scopeId3}>Vertical layout with consistent spacing</p><div class="demo-section" data-v-ac5292c5${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_LayoutColumn, { gap: "md" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="demo-box" data-v-ac5292c5${_scopeId4}>First Item</div><div class="demo-box" data-v-ac5292c5${_scopeId4}>Second Item</div><div class="demo-box" data-v-ac5292c5${_scopeId4}>Third Item</div>`);
                            } else {
                              return [
                        ...
                        _push4(`</div></section><section data-v-ac5292c5${_scopeId3}><h2 data-v-ac5292c5${_scopeId3}>LayoutGrid</h2><p class="section-description" data-v-ac5292c5${_scopeId3}>Responsive grid system with multiple layout options</p><div class="demo-subsection" data-v-ac5292c5${_scopeId3}><h3 data-v-ac5292c5${_scopeId3}>Fixed Columns</h3><div class="demo-section" data-v-ac5292c5${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_LayoutGrid, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<!--[-->`);
                              ssrRenderList(6, (i) => {
                                _push5(`<div class="demo-box" data-v-ac5292c5${_scopeId4}>${ssrInterpolate(i)}</div>`);
                              });
                              _push5(`<!--]-->`);
                            } else {
                              return [
                        ...
                        _push4(`</div></div><div class="demo-subsection" data-v-ac5292c5${_scopeId3}><h3 data-v-ac5292c5${_scopeId3}>Responsive Columns</h3><div class="demo-section" data-v-ac5292c5${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_LayoutGrid, {
                        ...
                        _push4(`</div></div><div class="demo-subsection" data-v-ac5292c5${_scopeId3}><h3 data-v-ac5292c5${_scopeId3}>Auto-fit Grid</h3><div class="demo-section" data-v-ac5292c5${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_LayoutGrid, {
                          "auto-fit": true,
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<!--[-->`);
                              ssrRenderList(5, (i) => {
                                _push5(`<div class="demo-box" data-v-ac5292c5${_scopeId4}>Auto ${ssrInterpolate(i)}</div>`);
                              });
                              _push5(`<!--]-->`);
                            } else {
                              return [
                        ...
                        _push4(`</div></div></section><section data-v-ac5292c5${_scopeId3}><h2 data-v-ac5292c5${_scopeId3}>LayoutStack</h2><p class="section-description" data-v-ac5292c5${_scopeId3}>Overlapping layout for creating depth and layered UIs</p><div class="demo-section" data-v-ac5292c5${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_LayoutStack, { style: { "height": "200px" } }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="stack-layer stack-layer-1" data-v-ac5292c5${_scopeId4}>Background Layer</div><div class="stack-layer stack-layer-2" data-v-ac5292c5${_scopeId4}>Middle Layer</div><div class="stack-layer stack-layer-3" data-v-ac5292c5${_scopeId4}>`);
                              _push5(ssrRenderComponent(_component_LayoutAligned, { alignment: "topRight" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="stack-badge" data-v-ac5292c5${_scopeId5}>Top Layer</div>`);
                                  } else {
                                    return [
                        ...
                        _push4(`</div></section><section data-v-ac5292c5${_scopeId3}><h2 data-v-ac5292c5${_scopeId3}>LayoutWrap</h2><p class="section-description" data-v-ac5292c5${_scopeId3}>Wrapping layout that flows items to new rows</p><div class="demo-section" data-v-ac5292c5${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_LayoutWrap, { gap: "md" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<!--[-->`);
                              ssrRenderList(10, (i) => {
                                _push5(`<div class="demo-chip" data-v-ac5292c5${_scopeId4}>Tag ${ssrInterpolate(i)}</div>`);
                              });
                              _push5(`<!--]-->`);
                            } else {
                              return [
                        ...
                        _push4(`</div></section><section data-v-ac5292c5${_scopeId3}><h2 data-v-ac5292c5${_scopeId3}>LayoutExpanded</h2><p class="section-description" data-v-ac5292c5${_scopeId3}>Expands child to fill available space</p><div class="demo-section" data-v-ac5292c5${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_LayoutRow, {
                          gap: "md",
                          style: { "height": "100px" }
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="demo-box" data-v-ac5292c5${_scopeId4}>Fixed</div>`);
                              _push5(ssrRenderComponent(_component_LayoutExpanded, null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="demo-box demo-expanded" data-v-ac5292c5${_scopeId5}>Expanded to fill</div>`);
                                  } else {
                                    return [
                        ...
                        _push4(`</div></section><section data-v-ac5292c5${_scopeId3}><h2 data-v-ac5292c5${_scopeId3}>LayoutAligned</h2><p class="section-description" data-v-ac5292c5${_scopeId3}>Positions content within its parent</p><div class="demo-section" style="${ssrRenderStyle({ "height": "300px", "position": "relative" })}" data-v-ac5292c5${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_LayoutAligned, { alignment: "topLeft" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="aligned-box" data-v-ac5292c5${_scopeId4}>Top Left</div>`);
                            } else {
                              return [
                        ...
                        _push4(ssrRenderComponent(_component_LayoutAligned, { alignment: "topCenter" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="aligned-box" data-v-ac5292c5${_scopeId4}>Top Center</div>`);
                            } else {
                              return [
                        ...
                        _push4(ssrRenderComponent(_component_LayoutAligned, { alignment: "topRight" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="aligned-box" data-v-ac5292c5${_scopeId4}>Top Right</div>`);
                            } else {
                              return [
                        ...
                        _push4(ssrRenderComponent(_component_LayoutAligned, { alignment: "centerLeft" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="aligned-box" data-v-ac5292c5${_scopeId4}>Center Left</div>`);
                            } else {
                              return [
                        ...
                        _push4(ssrRenderComponent(_component_LayoutAligned, { alignment: "center" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="aligned-box aligned-box-center" data-v-ac5292c5${_scopeId4}>Center</div>`);
                            } else {
                              return [
                        ...
                        _push4(ssrRenderComponent(_component_LayoutAligned, { alignment: "centerRight" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="aligned-box" data-v-ac5292c5${_scopeId4}>Center Right</div>`);
                            } else {
                              return [
                        ...
                        _push4(ssrRenderComponent(_component_LayoutAligned, { alignment: "bottomLeft" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="aligned-box" data-v-ac5292c5${_scopeId4}>Bottom Left</div>`);
                            } else {
                              return [
                        ...
                        _push4(ssrRenderComponent(_component_LayoutAligned, { alignment: "bottomCenter" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="aligned-box" data-v-ac5292c5${_scopeId4}>Bottom Center</div>`);
                            } else {
                              return [
                        ...
                        _push4(ssrRenderComponent(_component_LayoutAligned, { alignment: "bottomRight" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="aligned-box" data-v-ac5292c5${_scopeId4}>Bottom Right</div>`);
                            } else {
                              return [
                        ...
                        _push4(`</div></section><section data-v-ac5292c5${_scopeId3}><h2 data-v-ac5292c5${_scopeId3}>LayoutSafeArea</h2><p class="section-description" data-v-ac5292c5${_scopeId3}>Ensures content avoids device notches and system UI</p><div class="demo-section demo-safe-area" data-v-ac5292c5${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_LayoutSafeArea, { all: true }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="demo-box" data-v-ac5292c5${_scopeId4}><p data-v-ac5292c5${_scopeId4}> This content respects safe area insets on devices with notches or rounded corners </p></div>`);
                            } else {
                              return [
                                createVNode("div", { class: "demo-box" }, [
                        ...
                        _push4(`</div></section><section data-v-ac5292c5${_scopeId3}><h2 data-v-ac5292c5${_scopeId3}>Complex Layout Example</h2><p class="section-description" data-v-ac5292c5${_scopeId3}>Combining multiple layout primitives</p><div class="demo-section" data-v-ac5292c5${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_LayoutContainer, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                                        ...
                                        if (_push7) {
                                          _push7(ssrRenderComponent(_component_LayoutExpanded, null, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<div class="complex-card" data-v-ac5292c5${_scopeId7}><h4 data-v-ac5292c5${_scopeId7}>Main Content</h4><p data-v-ac5292c5${_scopeId7}>This card expands to fill available space</p></div>`);
                                              } else {
                                                return [
                                          ...
                                          _push7(`<div class="complex-sidebar" data-v-ac5292c5${_scopeId6}><h4 data-v-ac5292c5${_scopeId6}>Sidebar</h4>`);
                                          _push7(ssrRenderComponent(_component_LayoutColumn, { gap: "sm" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<div class="sidebar-item" data-v-ac5292c5${_scopeId7}>Item 1</div><div class="sidebar-item" data-v-ac5292c5${_scopeId7}>Item 2</div><div class="sidebar-item" data-v-ac5292c5${_scopeId7}>Item 3</div>`);
                                              } else {
                                                return [
                                    ...
                                    _push6(ssrRenderComponent(_component_LayoutGrid, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<!--[-->`);
                                          ssrRenderList(4, (i) => {
                                            _push7(`<div class="stat-card" data-v-ac5292c5${_scopeId6}><div class="stat-value" data-v-ac5292c5${_scopeId6}>${ssrInterpolate(25 * i)}%</div><div class="stat-label" data-v-ac5292c5${_scopeId6}>Metric ${ssrInterpolate(i)}</div></div>`);
                                          });
                                          _push7(`<!--]-->`);
                                        } else {
                                          return [
...
const layouts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ac5292c5"]]);

export { layouts as default };
//# sourceMappingURL=layouts-CkOL5xii.mjs.map
