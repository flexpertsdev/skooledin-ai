...
import { l as lazyComponent, a as lazyLoadOnVisible, E as ErrorBoundary, L as LoadingSpinner } from './ErrorBoundary-IjTInuof.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-97a91702>`);
      if (_ctx.$slots.image || _ctx.image) {
        _push(`<div class="card-image" data-v-97a91702>`);
        ssrRenderSlot(_ctx.$slots, "image", {}, () => {
          if (_ctx.image) {
            _push(`<img${ssrRenderAttr("src", _ctx.image)}${ssrRenderAttr("alt", _ctx.imageAlt || _ctx.title)}${ssrRenderAttr("loading", _ctx.loading)} data-v-97a91702>`);
          } else {
            _push(`<!---->`);
          }
        }, _push, _parent);
      ...
      if (_ctx.$slots.header || _ctx.title || _ctx.subtitle) {
        _push(`<header class="card-header" data-v-97a91702>`);
        ssrRenderSlot(_ctx.$slots, "header", {}, () => {
          if (_ctx.title) {
            _push(`<h3 class="card-title" data-v-97a91702>${ssrInterpolate(_ctx.title)}</h3>`);
          } else {
            _push(`<!---->`);
          }
          if (_ctx.subtitle) {
            _push(`<p class="card-subtitle" data-v-97a91702>${ssrInterpolate(_ctx.subtitle)}</p>`);
          } else {
            _push(`<!---->`);
          }
        }, _push, _parent);
      ...
      if (_ctx.$slots.default) {
        _push(`<div class="card-content" data-v-97a91702>`);
      ...
      if (_ctx.$slots.actions) {
        _push(`<footer class="card-actions" data-v-97a91702>`);
...
const Card = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-97a91702"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "carousel",
  __ssrInlineRender: true,
  setup(__props) {
    const Carousel = lazyComponent(() => import('./Carousel-kJ8dnrbn.mjs'), {
      loadingComponent: LoadingSpinner,
      errorComponent: ErrorBoundary,
      delay: 200
    });
    const PageView = lazyLoadOnVisible(() => import('./PageView-Cc6wkYI5.mjs'));
    const MasonryGrid = lazyLoadOnVisible(() => import('./MasonryGrid-DNM8eC42.mjs'));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "carousel-demo" }, _attrs))} data-v-dd8cc353>`);
      _push(ssrRenderComponent(_component_LayoutContainer, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="demo-header" data-v-dd8cc353${_scopeId}><h1 data-v-dd8cc353${_scopeId}>Carousel &amp; Swipe Components</h1><p data-v-dd8cc353${_scopeId}>Touch-enabled carousels, page views, and masonry layouts</p></div><section data-v-dd8cc353${_scopeId}><h2 data-v-dd8cc353${_scopeId}>Carousel Component</h2><div class="demo-section" data-v-dd8cc353${_scopeId}><h3 data-v-dd8cc353${_scopeId}>Basic Carousel</h3><p data-v-dd8cc353${_scopeId}>Single item carousel with indicators and controls</p><div class="carousel-wrapper" data-v-dd8cc353${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Carousel), {
              ...
              slide: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="carousel-slide" data-v-dd8cc353${_scopeId2}><img${ssrRenderAttr("src", item.src)}${ssrRenderAttr("alt", item.alt)} data-v-dd8cc353${_scopeId2}><div class="carousel-caption" data-v-dd8cc353${_scopeId2}><h4 data-v-dd8cc353${_scopeId2}>${ssrInterpolate(item.title)}</h4><p data-v-dd8cc353${_scopeId2}>${ssrInterpolate(item.description)}</p></div></div>`);
                } else {
                  return [
            ...
            _push2(`</div></div><div class="demo-section" data-v-dd8cc353${_scopeId}><h3 data-v-dd8cc353${_scopeId}>Multi-item Carousel</h3><p data-v-dd8cc353${_scopeId}>Shows multiple items at once with responsive columns</p><div class="carousel-wrapper" data-v-dd8cc353${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Carousel), {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(Card, { clickable: "" }, {
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", item.image)}${ssrRenderAttr("alt", item.name)} class="product-image" data-v-dd8cc353${_scopeId3}><h4 data-v-dd8cc353${_scopeId3}>${ssrInterpolate(item.name)}</h4><p class="product-price" data-v-dd8cc353${_scopeId3}>$${ssrInterpolate(item.price)}</p>`);
                      } else {
                        return [
                          createVNode("img", {
                            src: item.image,
            ...
            _push2(`</div></div><div class="demo-section" data-v-dd8cc353${_scopeId}><h3 data-v-dd8cc353${_scopeId}>Vertical Carousel</h3><p data-v-dd8cc353${_scopeId}>Vertical scrolling with autoplay</p><div class="carousel-wrapper vertical" data-v-dd8cc353${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Carousel), {
              ...
              slide: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="testimonial" data-v-dd8cc353${_scopeId2}><p class="testimonial-quote" data-v-dd8cc353${_scopeId2}>&quot;${ssrInterpolate(item.quote)}&quot;</p><div class="testimonial-author" data-v-dd8cc353${_scopeId2}><img${ssrRenderAttr("src", item.avatar)}${ssrRenderAttr("alt", item.name)} data-v-dd8cc353${_scopeId2}><div data-v-dd8cc353${_scopeId2}><strong data-v-dd8cc353${_scopeId2}>${ssrInterpolate(item.name)}</strong><span data-v-dd8cc353${_scopeId2}>${ssrInterpolate(item.role)}</span></div></div></div>`);
                } else {
                  return [
            ...
            _push2(`</div></div></section><section data-v-dd8cc353${_scopeId}><h2 data-v-dd8cc353${_scopeId}>PageView Component</h2><div class="demo-section" data-v-dd8cc353${_scopeId}><h3 data-v-dd8cc353${_scopeId}>Full-screen Page Navigation</h3><p data-v-dd8cc353${_scopeId}>Swipe between full-screen pages</p><button class="demo-button" data-v-dd8cc353${_scopeId}>Open PageView Demo</button></div><div class="demo-section" data-v-dd8cc353${_scopeId}><h3 data-v-dd8cc353${_scopeId}>Inline PageView</h3><p data-v-dd8cc353${_scopeId}>Embedded page navigation with effects</p><div class="pageview-wrapper" data-v-dd8cc353${_scopeId}>`);
            _push2(ssrRenderComponent(unref(PageView), {
              ...
              page: withCtx(({ page, isActive }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="${ssrRenderClass([{ active: isActive }, "content-page"])}" data-v-dd8cc353${_scopeId2}><div class="page-content" data-v-dd8cc353${_scopeId2}><h3 data-v-dd8cc353${_scopeId2}>${ssrInterpolate(page.title)}</h3><p data-v-dd8cc353${_scopeId2}>${ssrInterpolate(page.content)}</p>`);
                  if (page.action) {
                    _push3(`<button class="page-action" data-v-dd8cc353${_scopeId2}>${ssrInterpolate(page.action)}</button>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div></div>`);
            ...
            _push2(`</div></div></section><section data-v-dd8cc353${_scopeId}><h2 data-v-dd8cc353${_scopeId}>MasonryGrid Component</h2><div class="demo-section" data-v-dd8cc353${_scopeId}><h3 data-v-dd8cc353${_scopeId}>Pinterest-style Layout</h3><p data-v-dd8cc353${_scopeId}>Responsive masonry grid with optimal item placement</p>`);
            _push2(ssrRenderComponent(unref(MasonryGrid), {
              ...
              default: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="masonry-item" style="${ssrRenderStyle({ height: item.height + "px" })}" data-v-dd8cc353${_scopeId2}><img${ssrRenderAttr("src", item.image)}${ssrRenderAttr("alt", item.title)} data-v-dd8cc353${_scopeId2}><div class="masonry-content" data-v-dd8cc353${_scopeId2}><h4 data-v-dd8cc353${_scopeId2}>${ssrInterpolate(item.title)}</h4><p data-v-dd8cc353${_scopeId2}>${ssrInterpolate(item.description)}</p></div></div>`);
                } else {
                  return [
                    createVNode("div", {
                      class: "masonry-item",
            ...
            _push2(`</div><div class="demo-section" data-v-dd8cc353${_scopeId}><h3 data-v-dd8cc353${_scopeId}>Mixed Content Types</h3><p data-v-dd8cc353${_scopeId}>Combining different content types in masonry layout</p>`);
            _push2(ssrRenderComponent(unref(MasonryGrid), {
              items: mixedContent,
              columns: 3,
              gap: 24,
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(Card, {
                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (item.image) {
                          _push4(`<img${ssrRenderAttr("src", item.image)}${ssrRenderAttr("alt", item.title)} data-v-dd8cc353${_scopeId3}>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        if (item.type === "quote") {
                          _push4(`<div class="quote-content" data-v-dd8cc353${_scopeId3}><blockquote data-v-dd8cc353${_scopeId3}>${ssrInterpolate(item.content)}</blockquote><cite data-v-dd8cc353${_scopeId3}>- ${ssrInterpolate(item.author)}</cite></div>`);
                        } else {
                          _push4(`<div class="card-content" data-v-dd8cc353${_scopeId3}><span class="content-type" data-v-dd8cc353${_scopeId3}>${ssrInterpolate(item.type)}</span><h4 data-v-dd8cc353${_scopeId3}>${ssrInterpolate(item.title)}</h4><p data-v-dd8cc353${_scopeId3}>${ssrInterpolate(item.description)}</p></div>`);
                        }
                      } else {
                        return [
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (showPageView.value) {
          _push2(`<div class="fullscreen-pageview" data-v-dd8cc353><button class="close-button" data-v-dd8cc353>\u2715</button>`);
          _push2(ssrRenderComponent(unref(PageView), {
            ...
            page: withCtx(({ page, index }, _push3, _parent2, _scopeId) => {
              if (_push3) {
                _push3(`<div class="onboarding-page" data-v-dd8cc353${_scopeId}><div class="onboarding-content" data-v-dd8cc353${_scopeId}><div class="onboarding-icon" data-v-dd8cc353${_scopeId}>${ssrInterpolate(page.icon)}</div><h2 data-v-dd8cc353${_scopeId}>${ssrInterpolate(page.title)}</h2><p data-v-dd8cc353${_scopeId}>${ssrInterpolate(page.description)}</p>`);
                if (index === onboardingPages.length - 1) {
                  _push3(`<button class="onboarding-button" data-v-dd8cc353${_scopeId}> Get Started </button>`);
                } else {
                  _push3(`<!---->`);
                }
                _push3(`</div></div>`);
...
const carousel = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dd8cc353"]]);

export { carousel as default };
//# sourceMappingURL=carousel-BCTj9wxh.mjs.map
