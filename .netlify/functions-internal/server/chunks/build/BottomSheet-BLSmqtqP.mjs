    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        if (_ctx.modelValue || unref(isAnimating)) {
          _push2(`<div class="bottom-sheet-wrapper" data-v-8d311b2c>`);
          if (_ctx.modelValue && _ctx.backdrop) {
            _push2(`<div class="bottom-sheet-backdrop" style="${ssrRenderStyle({ opacity: unref(backdropOpacity) })}" data-v-8d311b2c></div>`);
          } else {
            _push2(`<!---->`);
          }
          ...
          }, "bottom-sheet"])}" style="${ssrRenderStyle(unref(sheetStyles))}" role="dialog"${ssrRenderAttr("aria-modal", true)}${ssrRenderAttr("aria-label", _ctx.ariaLabel)} data-v-8d311b2c>`);
          if (_ctx.showHandle) {
            _push2(`<div class="bottom-sheet-handle-container" data-v-8d311b2c><div class="bottom-sheet-handle" data-v-8d311b2c></div></div>`);
          } else {
            _push2(`<!---->`);
          }
          if (_ctx.$slots.header || _ctx.title) {
            _push2(`<div class="bottom-sheet-header" data-v-8d311b2c>`);
            ssrRenderSlot(_ctx.$slots, "header", {}, () => {
              _push2(`<h2 class="bottom-sheet-title" data-v-8d311b2c>${ssrInterpolate(_ctx.title)}</h2>`);
            }, _push2, _parent);
            if (_ctx.showCloseButton) {
              _push2(`<button class="bottom-sheet-close" aria-label="Close bottom sheet" data-v-8d311b2c><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-8d311b2c><path d="M18 6L6 18M6 6l12 12" data-v-8d311b2c></path></svg></button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
          ...
          _push2(`<div class="bottom-sheet-content" data-v-8d311b2c>`);
...
const BottomSheet = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8d311b2c"]]);

export { BottomSheet as default };
//# sourceMappingURL=BottomSheet-BLSmqtqP.mjs.map
