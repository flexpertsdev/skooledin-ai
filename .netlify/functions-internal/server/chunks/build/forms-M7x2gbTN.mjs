...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "demo-page" }, _attrs))} data-v-b48a8c25>`);
      _push(ssrRenderComponent(_component_LayoutContainer, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<h1 data-v-b48a8c25${_scopeId}>Form Components</h1><p class="subtitle" data-v-b48a8c25${_scopeId}>Progressive form components designed for mobile-first experiences</p><section class="demo-section" data-v-b48a8c25${_scopeId}><h2 data-v-b48a8c25${_scopeId}>ChatInput</h2><p data-v-b48a8c25${_scopeId}>A versatile chat input component with auto-resize, voice recording, and suggestions</p><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>Basic Chat Input</h3>`);
            ...
            _push2(`<p class="demo-value" data-v-b48a8c25${_scopeId}>Value: ${ssrInterpolate(chatMessage.value)}</p></div><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>With Character Counter</h3>`);
            _push2(ssrRenderComponent(_component_ChatInput, {
            ...
            _push2(`</div><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>With Voice &amp; Suggestions</h3>`);
            _push2(ssrRenderComponent(_component_ChatInput, {
            ...
            _push2(`</div><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>With Toolbar &amp; Actions</h3>`);
            _push2(ssrRenderComponent(_component_ChatInput, {
              ...
              toolbar: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="toolbar-actions" data-v-b48a8c25${_scopeId2}><button class="toolbar-btn" data-v-b48a8c25${_scopeId2}>Bold</button><button class="toolbar-btn" data-v-b48a8c25${_scopeId2}>Italic</button><button class="toolbar-btn" data-v-b48a8c25${_scopeId2}>Link</button><button class="toolbar-btn" data-v-b48a8c25${_scopeId2}>Code</button></div>`);
                } else {
                  return [
            ...
            _push2(`</div><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>Minimal Variant</h3>`);
            _push2(ssrRenderComponent(_component_ChatInput, {
            ...
            _push2(`</div></section><section class="demo-section" data-v-b48a8c25${_scopeId}><h2 data-v-b48a8c25${_scopeId}>BottomSheetSelect</h2><p data-v-b48a8c25${_scopeId}>A mobile-friendly select component that opens in a bottom sheet</p><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>Basic Select</h3>`);
            ...
            _push2(`<p class="demo-value" data-v-b48a8c25${_scopeId}>Selected: ${ssrInterpolate(selectedCountry.value)}</p></div><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>Searchable with Descriptions</h3>`);
            _push2(ssrRenderComponent(_component_BottomSheetSelect, {
            ...
            _push2(`<p class="demo-value" data-v-b48a8c25${_scopeId}>Selected: ${ssrInterpolate(selectedPlan.value)}</p></div><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>Grouped Options</h3>`);
            _push2(ssrRenderComponent(_component_BottomSheetSelect, {
            ...
            _push2(`</div><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>Different Variants</h3><div class="demo-grid" data-v-b48a8c25${_scopeId}>`);
            _push2(ssrRenderComponent(_component_BottomSheetSelect, {
            ...
            _push2(`</div></div></section><section class="demo-section" data-v-b48a8c25${_scopeId}><h2 data-v-b48a8c25${_scopeId}>ChoiceButtons</h2><p data-v-b48a8c25${_scopeId}>Touch-friendly choice buttons for single or multiple selection</p><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>Single Selection</h3>`);
            ...
            _push2(`<p class="demo-value" data-v-b48a8c25${_scopeId}>Selected: ${ssrInterpolate(selectedSize.value)}</p></div><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>Multiple Selection</h3>`);
            _push2(ssrRenderComponent(_component_ChoiceButtons, {
            ...
            _push2(`<p class="demo-value" data-v-b48a8c25${_scopeId}>Selected: ${ssrInterpolate((_a = selectedFeatures.value) == null ? void 0 : _a.join(", "))}</p></div><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>With Icons &amp; Descriptions</h3>`);
            _push2(ssrRenderComponent(_component_ChoiceButtons, {
            ...
            _push2(`</div><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>Grid Layout</h3>`);
            _push2(ssrRenderComponent(_component_ChoiceButtons, {
            ...
            _push2(`</div><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>Different Variants</h3><div class="demo-stack" data-v-b48a8c25${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ChoiceButtons, {
            ...
            _push2(`</div></div><div class="demo-group" data-v-b48a8c25${_scopeId}><h3 data-v-b48a8c25${_scopeId}>With Validation</h3>`);
            _push2(ssrRenderComponent(_component_ChoiceButtons, {
            ...
            _push2(`</div></section><section class="demo-section" data-v-b48a8c25${_scopeId}><h2 data-v-b48a8c25${_scopeId}>Complete Form Example</h2><p data-v-b48a8c25${_scopeId}>A complete form combining all components</p><div class="demo-form" data-v-b48a8c25${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ChoiceButtons, {
            ...
            _push2(`<button class="submit-btn" data-v-b48a8c25${_scopeId}>Submit Form</button></div></section>`);
          } else {
            return [
...
const forms = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b48a8c25"]]);

export { forms as default };
//# sourceMappingURL=forms-M7x2gbTN.mjs.map
