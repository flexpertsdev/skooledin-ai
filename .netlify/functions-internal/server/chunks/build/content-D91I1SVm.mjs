...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "content-demo" }, _attrs))} data-v-9a755965>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_LayoutStack, { spacing: "xl" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="demo-header" data-v-9a755965${_scopeId3}><h1 data-v-9a755965${_scopeId3}>Content Layout Components</h1><p data-v-9a755965${_scopeId3}>Responsive grids, cards, and content organization patterns</p></div><section data-v-9a755965${_scopeId3}><h2 data-v-9a755965${_scopeId3}>CardGrid Component</h2><div class="demo-section" data-v-9a755965${_scopeId3}><h3 data-v-9a755965${_scopeId3}>Auto-fill Grid (Default)</h3><p data-v-9a755965${_scopeId3}>Automatically fills available space with cards</p>`);
                              ...
                              ssrRenderList(6, (i) => {
                                _push5(ssrRenderComponent(_component_Card, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<p data-v-9a755965${_scopeId5}>This card automatically sizes based on available space with a minimum width.</p>`);
                                    } else {
                                      return [
                        ...
                        _push4(`</div><div class="demo-section" data-v-9a755965${_scopeId3}><h3 data-v-9a755965${_scopeId3}>Fixed Column Grid</h3><p data-v-9a755965${_scopeId3}>Responsive column counts</p>`);
                              ...
                              ssrRenderList(8, (i) => {
                                _push5(ssrRenderComponent(_component_Card, {
                                  ...
                                  actions: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<button class="card-button" data-v-9a755965${_scopeId5}>Add to Cart</button>`);
                                    } else {
                                      return [
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<p data-v-9a755965${_scopeId5}>Fixed column layout adjusts based on breakpoints.</p>`);
                                    } else {
                                      return [
                        ...
                        _push4(`</div><div class="demo-section" data-v-9a755965${_scopeId3}><h3 data-v-9a755965${_scopeId3}>Masonry Layout</h3><p data-v-9a755965${_scopeId3}>Pinterest-style variable height layout</p>`);
                        _push4(ssrRenderComponent(_component_CardGrid, {
                            ...
                            if (_push5) {
                              ...
                              ssrRenderList(masonryItems, (item, i) => {
                                _push5(ssrRenderComponent(_component_Card, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<p data-v-9a755965${_scopeId5}>${ssrInterpolate(item.content)}</p>`);
                                    } else {
                                      return [
                        ...
                        _push4(`</div><div class="demo-section" data-v-9a755965${_scopeId3}><h3 data-v-9a755965${_scopeId3}>Card Variants</h3>`);
                        _push4(ssrRenderComponent(_component_CardGrid, {
                          columns: 4,
                          gap: "md"
                        }, {
                            ...
                            if (_push5) {
                              ...
                              ssrRenderList(cardVariants, (variant) => {
                                _push5(ssrRenderComponent(_component_Card, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<p data-v-9a755965${_scopeId5}>This is a ${ssrInterpolate(variant)} card variant.</p>`);
                                    } else {
                                      return [
                        ...
                        _push4(`</div><div class="demo-section" data-v-9a755965${_scopeId3}><h3 data-v-9a755965${_scopeId3}>Content Cards</h3>`);
                        _push4(ssrRenderComponent(_component_CardGrid, {
                          columns: 3,
                          gap: "lg"
                        }, {
                            ...
                            if (_push5) {
                              ...
                              ssrRenderList(features, (feature) => {
                                _push5(ssrRenderComponent(_component_Card, {
                                  ...
                                  actions: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<a href="#" class="card-link" data-v-9a755965${_scopeId5}>Learn more \u2192</a>`);
                                    } else {
                                      return [
                                        createVNode("a", {
                                          href: "#",
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="feature-icon" data-v-9a755965${_scopeId5}>${ssrInterpolate(feature.icon)}</div><p data-v-9a755965${_scopeId5}>${ssrInterpolate(feature.description)}</p>`);
                                    } else {
                                      return [
                        ...
                        _push4(`</div><div class="demo-section" data-v-9a755965${_scopeId3}><h3 data-v-9a755965${_scopeId3}>Mixed Content Grid</h3>`);
                        _push4(ssrRenderComponent(_component_CardGrid, {
                          columns: "auto-fit",
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_Card, {
                                ...
                                actions: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<button class="card-button card-button-primary" data-v-9a755965${_scopeId5}>Read More</button>`);
                                  } else {
                                    return [
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<p data-v-9a755965${_scopeId5}>This featured card spans two columns on larger screens for emphasis.</p>`);
                                  } else {
                                    return [
                              ...
                              ssrRenderList(4, (i) => {
                                _push5(ssrRenderComponent(_component_Card, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<p data-v-9a755965${_scopeId5}>Regular sized cards fit alongside the featured content.</p>`);
                                    } else {
                                      return [
                        ...
                        _push4(`</div></section><section data-v-9a755965${_scopeId3}><h2 data-v-9a755965${_scopeId3}>Common Patterns</h2><div class="demo-section" data-v-9a755965${_scopeId3}><h3 data-v-9a755965${_scopeId3}>Team Members</h3>`);
                        _push4(ssrRenderComponent(_component_CardGrid, {
                          columns: 4,
                          gap: "md"
                        }, {
                              ...
                              ssrRenderList(teamMembers, (member) => {
                                _push5(ssrRenderComponent(_component_Card, {
                                  ...
                                  header: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<h4 class="member-name" data-v-9a755965${_scopeId5}>${ssrInterpolate(member.name)}</h4><p class="member-role" data-v-9a755965${_scopeId5}>${ssrInterpolate(member.role)}</p>`);
                                    } else {
                                      return [
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="member-links" data-v-9a755965${_scopeId5}><a href="#" aria-label="Email" data-v-9a755965${_scopeId5}>\u{1F4E7}</a><a href="#" aria-label="LinkedIn" data-v-9a755965${_scopeId5}>\u{1F4BC}</a></div>`);
                                    } else {
                                      return [
                        ...
                        _push4(`</div><div class="demo-section" data-v-9a755965${_scopeId3}><h3 data-v-9a755965${_scopeId3}>Dashboard Stats</h3>`);
                        _push4(ssrRenderComponent(_component_CardGrid, {
                            ...
                            if (_push5) {
                              ...
                              ssrRenderList(stats, (stat) => {
                                _push5(ssrRenderComponent(_component_Card, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="stat-value" style="${ssrRenderStyle({ color: stat.color })}" data-v-9a755965${_scopeId5}>${ssrInterpolate(stat.value)}</div><div class="stat-label" data-v-9a755965${_scopeId5}>${ssrInterpolate(stat.label)}</div><div class="${ssrRenderClass([stat.trend, "stat-change"])}" data-v-9a755965${_scopeId5}>${ssrInterpolate(stat.change)}</div>`);
                                    } else {
                                      return [
                                        createVNode("div", {
                                          class: "stat-value",
...
const content = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9a755965"]]);

export { content as default };
//# sourceMappingURL=content-D91I1SVm.mjs.map
