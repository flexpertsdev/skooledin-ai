    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        if (_ctx.modelValue || unref(isAnimating)) {
          _push2(`<div class="drawer-wrapper" data-v-52dceb50>`);
          if (_ctx.modelValue && _ctx.backdrop) {
            _push2(`<div class="drawer-backdrop" data-v-52dceb50></div>`);
          } else {
            _push2(`<!---->`);
          }
          if (_ctx.modelValue) {
            _push2(`<div class="${ssrRenderClass([unref(drawerClasses), "drawer"])}" style="${ssrRenderStyle(unref(drawerStyles))}" role="dialog"${ssrRenderAttr("aria-modal", true)}${ssrRenderAttr("aria-label", _ctx.ariaLabel)} data-v-52dceb50>`);
            if (_ctx.$slots.header || _ctx.title) {
              _push2(`<div class="drawer-header" data-v-52dceb50>`);
              ssrRenderSlot(_ctx.$slots, "header", {}, () => {
                _push2(`<h2 class="drawer-title" data-v-52dceb50>${ssrInterpolate(_ctx.title)}</h2>`);
              }, _push2, _parent);
              if (_ctx.showCloseButton) {
                _push2(`<button class="drawer-close" aria-label="Close drawer" type="button" data-v-52dceb50><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-52dceb50><path d="M18 6L6 18M6 6l12 12" data-v-52dceb50></path></svg></button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            _push2(`<div class="drawer-content" data-v-52dceb50>`);
            ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent);
            _push2(`</div>`);
            if (_ctx.$slots.footer) {
              _push2(`<div class="drawer-footer" data-v-52dceb50>`);
...
const Drawer = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-52dceb50"]]);

export { Drawer as default };
//# sourceMappingURL=Drawer-Du3uazel.mjs.map
