  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref: containerRef,
        class: ["masonry-grid", [
          `masonry-grid--cols-${columns.value}`,
          _ctx.fillLastRow && "masonry-grid--fill-last"
        ]],
        style: containerStyle.value
      }, _attrs))} data-v-cc7ed18e><!--[-->`);
      ssrRenderList(columnItems.value, (column, columnIndex) => {
        _push(`<div class="masonry-grid__column" style="${ssrRenderStyle(columnStyle.value)}" data-v-cc7ed18e><!--[-->`);
        ssrRenderList(column, (item, itemIndex) => {
          _push(`<div class="masonry-grid__item" style="${ssrRenderStyle({ marginBottom: `${_ctx.gap}px` })}" data-v-cc7ed18e>`);
...
const MasonryGrid = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cc7ed18e"]]);

export { MasonryGrid as default };
//# sourceMappingURL=MasonryGrid-CD4pQcMp.mjs.map
