...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "images-demo" }, _attrs))} data-v-23176be5><header class="demo-header" data-v-23176be5>`);
      _push(ssrRenderComponent(_component_Container, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 class="demo-title" data-v-23176be5${_scopeId}>Image Optimization</h1><p class="demo-description" data-v-23176be5${_scopeId}> Responsive images with lazy loading, progressive enhancement, and optimal formats. </p>`);
          } else {
            return [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_Stack, { gap: 32 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<section class="demo-section" data-v-23176be5${_scopeId2}><h2 class="section-title" data-v-23176be5${_scopeId2}>Responsive Images</h2><p class="section-description" data-v-23176be5${_scopeId2}> Automatically serve the right image size for each device and screen resolution. </p>`);
                  _push3(ssrRenderComponent(_component_Grid, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="demo-card" data-v-23176be5${_scopeId3}><h3 data-v-23176be5${_scopeId3}>Cover Fit</h3>`);
                        ...
                        _push4(`</div><div class="demo-card" data-v-23176be5${_scopeId3}><h3 data-v-23176be5${_scopeId3}>Contain Fit</h3>`);
                        _push4(ssrRenderComponent(_component_ResponsiveImage, {
                        ...
                        _push4(`</div><div class="demo-card" data-v-23176be5${_scopeId3}><h3 data-v-23176be5${_scopeId3}>With Caption</h3>`);
                        _push4(ssrRenderComponent(_component_ResponsiveImage, {
                  ...
                  _push3(`</section><section class="demo-section" data-v-23176be5${_scopeId2}><h2 class="section-title" data-v-23176be5${_scopeId2}>Progressive Loading</h2><p class="section-description" data-v-23176be5${_scopeId2}> Images load with blur placeholders and fade in smoothly when ready. </p><div class="progressive-grid" data-v-23176be5${_scopeId2}><!--[-->`);
                  ssrRenderList(6, (i) => {
                    _push3(`<div class="demo-card" data-v-23176be5${_scopeId2}>`);
                    ...
                    _push3(`<p class="image-label" data-v-23176be5${_scopeId2}>${ssrInterpolate(i <= 2 ? "Eager loaded" : "Lazy loaded")}</p></div>`);
                  });
                  _push3(`<!--]--></div></section><section class="demo-section" data-v-23176be5${_scopeId2}><h2 class="section-title" data-v-23176be5${_scopeId2}>Image Gallery</h2><p class="section-description" data-v-23176be5${_scopeId2}>Grid and masonry layouts with lightbox support.</p>`);
                  ...
                  _push3(`</section><section class="demo-section" data-v-23176be5${_scopeId2}><h2 class="section-title" data-v-23176be5${_scopeId2}>Error Handling</h2><p class="section-description" data-v-23176be5${_scopeId2}>Graceful error states when images fail to load.</p>`);
                  _push3(ssrRenderComponent(_component_Grid, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="demo-card" data-v-23176be5${_scopeId3}><h3 data-v-23176be5${_scopeId3}>Failed Image</h3>`);
                        _push4(ssrRenderComponent(_component_ResponsiveImage, {
                        ...
                        _push4(`</div><div class="demo-card" data-v-23176be5${_scopeId3}><h3 data-v-23176be5${_scopeId3}>With Spinner</h3>`);
                        _push4(ssrRenderComponent(_component_ResponsiveImage, {
                        ...
                        _push4(`</div><div class="demo-card" data-v-23176be5${_scopeId3}><h3 data-v-23176be5${_scopeId3}>No Placeholder</h3>`);
                        _push4(ssrRenderComponent(_component_ResponsiveImage, {
                  ...
                  _push3(`</section><section class="demo-section" data-v-23176be5${_scopeId2}><h2 class="section-title" data-v-23176be5${_scopeId2}>Performance Impact</h2><p class="section-description" data-v-23176be5${_scopeId2}> See how image optimization improves loading performance. </p><div class="metrics-comparison" data-v-23176be5${_scopeId2}><div class="metric-card" data-v-23176be5${_scopeId2}><h3 data-v-23176be5${_scopeId2}>Without Optimization</h3><div class="metric-item" data-v-23176be5${_scopeId2}><span class="metric-label" data-v-23176be5${_scopeId2}>Average Size</span><span class="metric-value" data-v-23176be5${_scopeId2}>2.5 MB</span></div><div class="metric-item" data-v-23176be5${_scopeId2}><span class="metric-label" data-v-23176be5${_scopeId2}>Load Time</span><span class="metric-value" data-v-23176be5${_scopeId2}>3.2s</span></div><div class="metric-item" data-v-23176be5${_scopeId2}><span class="metric-label" data-v-23176be5${_scopeId2}>Format</span><span class="metric-value" data-v-23176be5${_scopeId2}>JPEG only</span></div></div><div class="metric-card optimized" data-v-23176be5${_scopeId2}><h3 data-v-23176be5${_scopeId2}>With Optimization</h3><div class="metric-item" data-v-23176be5${_scopeId2}><span class="metric-label" data-v-23176be5${_scopeId2}>Average Size</span><span class="metric-value" data-v-23176be5${_scopeId2}>180 KB</span><span class="metric-improvement" data-v-23176be5${_scopeId2}>-93%</span></div><div class="metric-item" data-v-23176be5${_scopeId2}><span class="metric-label" data-v-23176be5${_scopeId2}>Load Time</span><span class="metric-value" data-v-23176be5${_scopeId2}>0.8s</span><span class="metric-improvement" data-v-23176be5${_scopeId2}>-75%</span></div><div class="metric-item" data-v-23176be5${_scopeId2}><span class="metric-label" data-v-23176be5${_scopeId2}>Format</span><span class="metric-value" data-v-23176be5${_scopeId2}>WebP/AVIF</span><span class="metric-improvement" data-v-23176be5${_scopeId2}>\u2713</span></div></div></div></section><section class="demo-section" data-v-23176be5${_scopeId2}><h2 class="section-title" data-v-23176be5${_scopeId2}>Usage Examples</h2><p class="section-description" data-v-23176be5${_scopeId2}>Code examples for common image optimization patterns.</p><div class="code-examples" data-v-23176be5${_scopeId2}><div class="example-card" data-v-23176be5${_scopeId2}><h3 data-v-23176be5${_scopeId2}>Basic Responsive Image</h3><pre data-v-23176be5${_scopeId2}><code data-v-23176be5${_scopeId2}>&lt;ResponsiveImage
  src=&quot;/images/hero.jpg&quot;
  alt=&quot;Hero image&quot;
  :width=&quot;1920&quot;
  :height=&quot;1080&quot;
...
/&gt;</code></pre></div><div class="example-card" data-v-23176be5${_scopeId2}><h3 data-v-23176be5${_scopeId2}>Gallery with Lightbox</h3><pre data-v-23176be5${_scopeId2}><code data-v-23176be5${_scopeId2}>&lt;ImageGallery
  :images=&quot;galleryImages&quot;
  layout=&quot;masonry&quot;
  :columns=&quot;3&quot;
  enable-lightbox
  placeholder=&quot;blur&quot;
/&gt;</code></pre></div><div class="example-card" data-v-23176be5${_scopeId2}><h3 data-v-23176be5${_scopeId2}>Priority Loading</h3><pre data-v-23176be5${_scopeId2}><code data-v-23176be5${_scopeId2}>&lt;ResponsiveImage
...
const images = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-23176be5"]]);

export { images as default };
//# sourceMappingURL=images-CxtZJqfh.mjs.map
