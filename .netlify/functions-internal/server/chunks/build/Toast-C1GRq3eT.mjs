    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        ...
        ssrRenderList(unref(visibleToasts), (toast) => {
          var _a, _b;
          _push2(`<div class="${ssrRenderClass([toastClasses(toast), "toast"])}" data-v-4fd0debe>`);
          if (toast.icon || getDefaultIcon(toast.type)) {
            _push2(`<div class="toast-icon" data-v-4fd0debe>`);
            if (toast.icon && typeof toast.icon !== "string") {
              ...
              _push2(`<span data-v-4fd0debe>${(_a = toast.icon) != null ? _a : ""}</span>`);
            } else {
              _push2(`<span data-v-4fd0debe>${(_b = getDefaultIcon(toast.type)) != null ? _b : ""}</span>`);
            }
            _push2(`</div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`<div class="toast-content" data-v-4fd0debe>`);
          if (toast.title) {
            _push2(`<h4 class="toast-title" data-v-4fd0debe>${ssrInterpolate(toast.title)}</h4>`);
          } else {
            _push2(`<!---->`);
          }
          if (toast.description) {
            _push2(`<p class="toast-description" data-v-4fd0debe>${ssrInterpolate(toast.description)}</p>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div>`);
          if (toast.action || toast.closable) {
            _push2(`<div class="toast-actions" data-v-4fd0debe>`);
            if (toast.action) {
              _push2(`<button class="toast-action" type="button" data-v-4fd0debe>${ssrInterpolate(toast.action.label)}</button>`);
            } else {
              _push2(`<!---->`);
            }
            if (toast.closable) {
              _push2(`<button class="toast-close" aria-label="Close notification" type="button" data-v-4fd0debe><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-4fd0debe><path d="M18 6L6 18M6 6l12 12" data-v-4fd0debe></path></svg></button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
          ...
          if (toast.duration && toast.showProgress) {
            _push2(`<div class="toast-progress" style="${ssrRenderStyle({ "--progress": getProgress(toast.id) })}" data-v-4fd0debe></div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div>`);
...
const Toast = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4fd0debe"]]);

export { Toast as default };
//# sourceMappingURL=Toast-C1GRq3eT.mjs.map
