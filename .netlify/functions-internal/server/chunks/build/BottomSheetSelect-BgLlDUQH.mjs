...
import BottomSheet from './BottomSheet-BLSmqtqP.mjs';
import { _ as _export_sfc } from './server.mjs';
import './index-C7HDIHE6.mjs';
import './useFocusTrap-DjmPMxVY.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bottom-sheet-select" }, _attrs))} data-v-181f4e47><div class="${ssrRenderClass([triggerClasses.value, "select-trigger"])}" data-v-181f4e47><div class="select-content" data-v-181f4e47>`);
      if (_ctx.label) {
        _push(`<span class="select-label" data-v-181f4e47>${ssrInterpolate(_ctx.label)}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<span class="${ssrRenderClass([{ "is-placeholder": !hasValue.value }, "select-value"])}" data-v-181f4e47>${ssrInterpolate(displayValue.value)}</span></div><svg class="select-arrow" viewBox="0 0 24 24" fill="currentColor" data-v-181f4e47><path d="M7 10l5 5 5-5H7z" data-v-181f4e47></path></svg></div>`);
      _push(ssrRenderComponent(BottomSheet, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (_ctx.searchable) {
              _push2(`<div class="select-search" data-v-181f4e47${_scopeId}><input${ssrRenderAttr("value", searchQuery.value)} type="text"${ssrRenderAttr("placeholder", _ctx.searchPlaceholder)} class="search-input" data-v-181f4e47${_scopeId}><svg class="search-icon" viewBox="0 0 24 24" fill="currentColor" data-v-181f4e47${_scopeId}><path d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0016 9.5 6.5 6.5 0 109.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z" data-v-181f4e47${_scopeId}></path></svg></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="${ssrRenderClass([{ "has-search": _ctx.searchable }, "select-options"])}" data-v-181f4e47${_scopeId}>`);
            if (grouped.value) {
              _push2(`<!--[-->`);
              ssrRenderList(filteredGroups.value, (group) => {
                _push2(`<div class="option-group" data-v-181f4e47${_scopeId}><div class="group-header" data-v-181f4e47${_scopeId}>${ssrInterpolate(group.label)}</div><!--[-->`);
                ssrRenderList(group.options, (option) => {
                  _push2(`<div class="${ssrRenderClass([{
                    "is-selected": isSelected(option),
                    "is-disabled": isDisabled(option)
                  }, "select-option"])}" data-v-181f4e47${_scopeId}><div class="option-content" data-v-181f4e47${_scopeId}><span class="option-label" data-v-181f4e47${_scopeId}>${ssrInterpolate(getOptionLabel(option))}</span>`);
                  if (getOptionDescription(option)) {
                    _push2(`<span class="option-description" data-v-181f4e47${_scopeId}>${ssrInterpolate(getOptionDescription(option))}</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div>`);
                  if (isSelected(option)) {
                    _push2(`<svg class="option-check" viewBox="0 0 24 24" fill="currentColor" data-v-181f4e47${_scopeId}><path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" data-v-181f4e47${_scopeId}></path></svg>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div>`);
            ...
            if (filteredOptions.value.length === 0) {
              _push2(`<div class="select-empty" data-v-181f4e47${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "empty", {}, () => {
                _push2(`<p data-v-181f4e47${_scopeId}>${ssrInterpolate(_ctx.emptyText)}</p>`);
            ...
            _push2(`</div>`);
            if (_ctx.showActions) {
              _push2(`<div class="select-actions" data-v-181f4e47${_scopeId}>`);
              if (_ctx.clearable && hasValue.value) {
                _push2(`<button type="button" class="action-btn clear-btn" data-v-181f4e47${_scopeId}> Clear </button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<button type="button" class="action-btn done-btn" data-v-181f4e47${_scopeId}>Done</button></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const BottomSheetSelect = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-181f4e47"]]);

export { BottomSheetSelect as default };
//# sourceMappingURL=BottomSheetSelect-BgLlDUQH.mjs.map
